...
#pragma warning disable CS0436 // Type conflicts with imported type
    public class AvatarBehaviourFusionCustom : NetworkBehaviour, IAvatarBehaviour
#pragma warning restore CS0436 // Type conflicts with imported type
    {
        ...
        private AvatarEntityCustom _avatar;
...
#if META_AVATAR_SDK_DEFINED
            _avatar = GetComponent<AvatarEntityCustom>();
            if (_avatar == null)
            {
                _avatar = gameObject.AddComponent<AvatarEntityCustom>();
            }
#endif // META_AVATAR_SDK_DEFINED
        }
