        ...
        private void Update()
        {
            if (!_setupBodyTracking)
            {
                ...
                if (OVRManager.instance)
                {
                    ...
                    new HandTrackingInputTrackingDelegate(_cameraRig, LeftHand, RightHand, Hmd);
                    BodyTracking.HandTrackingDelegate = new HandTrackingDelegate(_cameraRig, LeftHand, RightHand);
